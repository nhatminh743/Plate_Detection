...
import sys
import cv2
sys.path.append('/home/minhpn/Desktop/Green_Parking/Extract_Letter_From_Plate/Full_pipeline_YOLO_EasyOCR')
from helper_function.plotting import plot_result, crop_and_save_rois
