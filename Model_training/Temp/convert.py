...
label_dir = '/home/minhpn/Desktop/Green_Parking/Model_training/Temp/validate/labels'
output_dir = '/home/minhpn/Desktop/Green_Parking/Model_training/Temp/validate/json_output'

label_names = [str(i) for i in range(36)]  # 0–9 + A–Z if needed
