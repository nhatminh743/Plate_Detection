...
def report_result_YOLO_EasyOCR(long_report=True):
    test_dir = '/home/minhpn/Desktop/Green_Parking/Test_models/Validation.txt'
    validate_dir = '/home/minhpn/Desktop/Green_Parking/Test_models/YOLO_PaddleOCR/Final_Result/ocr_results.txt'
    compare_txt_files(test_dir, validate_dir, long_report=long_report)

if __name__ == '__main__':
    report_result_YOLO_EasyOCR()